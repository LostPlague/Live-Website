...
export const S_DETAIL: VisitorDetail = {
  ...
  timeline: [
    ...
    [iso(6 * day - 80e3), 'section_viewed', null, null, null, 95, '/os/about', 's1', 'about', null],
    [iso(6 * day - 190e3), 'section_viewed', null, null, null, 120, '/os/experience', 's1', 'experience', null],
    [iso(6 * day - 200e3), 'resume_downloaded', null, null, null, null, '/os/experience', 's1', null, null],
    [iso(6 * day - 260e3), 'app_closed', 'showcase', null, null, 240, '/os', 's1', null, null],
